...
// To update: replace the CSV at scripts/reunion-calendar.csv and run:
...
export interface CalendarEvent {
  ...
  location?: string;
  notes?: string;
  highlight?: boolean; // marks the main event day
}
...
export const reunionEvents: Record<number, CalendarEvent[]> = {
  ...
  15: [
    ...
    },
    {
      ...
      notes: "Bobby & Chris Crawford to host; cmorford to coordinate.",
    },
    {
      title: "Trivia Night",
      location: "TBD",
